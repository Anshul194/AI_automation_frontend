  ...
  const features = [
    {
      ...
      title: "ROAS Tracking",
      description:
        "Monitor return on ad spend across all campaigns with real-time insights and performance breakdowns.",
    },
    {
      icon: <Target className="h-8 w-8 text-dark-cta" />,
      title: "RTO Prediction",
      description:
        "Predict return to operations and identify high-risk regions before they impact your bottom line.",
    },
    {
      icon: <BarChart3 className="h-8 w-8 text-dark-cta" />,
      title: "Scaling Insights",
      description:
        "Get AI-powered recommendations on when to scale, pause, or optimize your advertising campaigns.",
    },
    {
      icon: <Users className="h-8 w-8 text-dark-cta" />,
      title: "Audience Analytics",
      description:
        "Understand performance by gender, age, and demographics to optimize targeting strategies.",
    },
    {
      icon: <MapPin className="h-8 w-8 text-dark-cta" />,
      title: "Geo Performance",
      description:
        "India-specific heatmaps and state-wise analysis to identify your best and worst performing regions.",
    },
    {
      icon: <Smartphone className="h-8 w-8 text-dark-cta" />,
      title: "Platform Insights",
      description:
        "Compare performance across Facebook, Instagram, Threads, and Audience Network placements.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "Increased our ROAS by 340% in just 2 months. The geo-targeting insights were game-changing.",
      rating: 5,
    },
    {
      name: "Rahul Gupta",
      ...
      content:
        "Finally understand which states to avoid. Saved us ₹50L in wasted ad spend last quarter.",
      rating: 5,
    },
    {
      name: "Anita Desai",
      role: "CEO, BeautyBox",
      content:
        "The audience breakdown by age and gender helped us 3x our conversion rate.",
      rating: 5,
    },
  ];
    ...
    <div className="min-h-screen bg-dark-bg">
      ...
      <header className="border-b border-dark-border bg-dark-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-dark-primary">
              GenZway Marketing
            </span>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            ...
            {isLoggedIn ? (
              <div className="relative ml-4" ref={profileRef}>
                ...
                {showProfile && (
                  <div className="absolute right-0 mt-2 w-56 bg-dark-card border border-dark-border rounded-xl shadow-lg p-4 z-50">
                    <div className="mb-2 font-semibold text-dark-primary">
                      {user?.name || "User"}
                    </div>
                    <div className="text-sm text-dark-secondary break-all">
                      {user?.email || "No email"}
                    </div>
                  </div>
                )}
              ...
              <Button onClick={onLogin} className="dark-button-primary">
                Login
              </Button>
            )}
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-dark-secondary leading-relaxed">
                Connect Facebook Ads + Shopify to get actionable insights on
                performance, audience targeting, and geographic optimization.
                Stop wasting ad spend on low-converting regions.
              </p>
              ...
              <div className="dark-card dark-shadow-lg p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-dark-hover rounded-lg">
                    <div className="text-2xl font-bold text-dark-positive">
                      ₹45.2L
                    </div>
                  ...
                  <div className="p-4 bg-dark-hover rounded-lg">
                    <div className="text-2xl font-bold text-dark-negative">
                      12%
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-dark-secondary">
              Comprehensive analytics and insights for D2C success
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="dark-card dark-shadow p-6 hover:shadow-lg transition-all duration-300"
              >
      ...
      <section id="testimonials" className="py-20 px-6 bg-dark-hover/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl font-bold text-dark-primary">
              Loved by 500+ D2C Brands
            </h2>
            <p className="text-xl text-dark-secondary">
              See how brands like yours are scaling with our platform
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <Card
                key={index}
                className={`dark-card dark-shadow p-8 relative ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center gap-8 text-sm text-dark-secondary">
              <a href="#" className="hover:text-dark-primary transition-colors">
                Terms
              </a>
              <a href="#" className="hover:text-dark-primary transition-colors">
                Privacy
