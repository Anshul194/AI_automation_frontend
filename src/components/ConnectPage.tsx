...
const PropertyModal = ({ open, properties, onConnect, onCancel }: { open: boolean; properties: any[], onConnect: (id: string) => void, onCancel: () => void }) => {
  if (!open) return null;
...
function ConnectPage({ onComplete }: { onComplete?: () => void }) {
  ...
  const handleMetaConnect = async () => {
    ...
    try {
      ...
      const redirectUrl = `${window.location.origin}/connect/meta-ads/select-account`;
      const url = await fetchMetaConnectUrl(userId, redirectUrl);
              ...
              <div className="flex items-start gap-8 md:flex-row md:items-center flex-col justify-between">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-full font-medium transition-all ${connections.shopify
              ...
              <div className="flex items-start gap-8 md:flex-row md:items-center flex-col justify-between">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-full font-medium transition-all ${connections.meta
                      ? "bg-dark-hover text-dark-secondary border border-dark-border hover:bg-dark-border"
                      : "bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700"
                      }`}
              ...
              <div className="flex items-start gap-8 md:flex-row md:items-center flex-col justify-between">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-full font-medium transition-all ${connections.analytics
                      ? "bg-dark-hover text-dark-secondary border border-dark-border hover:bg-dark-border"
                      : "bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700"
                      }`}
                    disabled={loading}
